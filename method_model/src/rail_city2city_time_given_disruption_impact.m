function city_city_time=rail_city2city_time_given_disruption_impact(model_para,rail_net_time,rail_city,dam_train,city_route_pass,norm_city_city_time)
...
timetable_edge(dam_train(timetable_edge(:,4))==1,:)=[];
